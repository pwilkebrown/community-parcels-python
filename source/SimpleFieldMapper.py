...
# Script to field map local parcels to community parcels schema for submission to curator
def main(config_file, *args):
    ...
    print "Loading Parcels to Community Parcels dataset"
    arcpy.AddMessage("Mapping Local Parcel data to Community Parcel Schema")
    arcpy.AddMessage("Loading Parcels to Community Parcels dataset")
    ...
    print "Updated Local Community Parcels"
    arcpy.AddMessage("Updated Local Community Parcels")
