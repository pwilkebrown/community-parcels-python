...
def main(config_file, *args):
	...
	if createCurrent == "True":
		...
		if LowParcelID == "":
			...
			new_field = """LOWPARCELID 'Low Parcel Identification Number' {}, {}, {}, -1, -1""".format(common_vars,
																									   LocalParcels,
																									   LowParcelID)
		...
		if ParcelID == "":
			...
			new_field = """PARCELID 'Parcel Identification Number' {}, {}, {}, -1, -1""".format(common_vars,
																								LocalParcels, ParcelID)
		...
		if FloorDesignator == "":
			...
			new_field = """FLOORDESIG 'Floor Designator' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																					  FloorDesignator)
		...
		if ConveyanceName == "":
			...
			new_field = """CNVYNAME 'Sub or Condo Name' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																					 ConveyanceName)
		...
		if UseDescription == "":
			...
			new_field = """USEDSCRP 'Parcel Use Description' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																						  UseDescription)
		...
		if TaxUseDescription == "":
			...
			new_field = """CVTTXDSCRP 'Tax District Description' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																							  TaxUseDescription)
		...
		if Improved == "":
			...
			new_field = """IMPROVED 'Improved Structure' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																					  Improved)
		...
		if SiteAddress == "":
			...
			new_field = """SITEADRESS 'Physical Address' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																					  SiteAddress)
		...
		if Ownername1 == "":
			...
			new_field = """OWNERNME1 'First Owner Name' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																					 Ownername1)
		...
		if Ownername2 == "":
			...
			new_field = """OWNERNME2 'Second Owner Name' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																					  Ownername2)
		...
		if PostalAddress == "":
			...
			new_field = """PSTLADRESS 'Mailing Address' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																					 PostalAddress)
		...
		if USPSBox == "":
			...
			new_field = """USPSBOX 'US Postal Box Number' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																					   USPSBox)
		...
		if InternationalAddress == "":
			...
			new_field = """PSTLINTER 'International Postal Address' {}, {}, {}, -1, -1""".format(common_vars,
																								 LocalParcels,
		...
		if TaxableValue == "":
			...
			new_field = """CNTTXBLVAL 'Current Taxable Value' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																						   TaxableValue)
		...
		if SalePrice == "":
			...
			new_field = """SALEPRICE 'Last Sale Price' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																					SalePrice)
		...
		if LocalFIPS == "":
			...
			new_field = """LOCALFIPS 'Local FIPS Code' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																					LocalFIPS)
		...
		if ImprovedValue == "":
			...
			new_field = """IMPVALUE 'Improved Structure Value' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																							ImprovedValue)
		...
		if AssessedValue == "":
			...
			new_field = """CNTASSDVAL 'Current Assessed Value' {}, {}, {}, -1, -1""".format(common_vars, LocalParcels,
																							AssessedValue)
		...
		if GNISID == "":
			...
			new_field = """GNISID 'Geographic Names Information System Code' {}, {}, {}, -1, -1""".format(common_vars,
																										  LocalParcels,
																										  GNISID)
		...
		arcpy.CalculateField_management(CommunityParcelsLocalCopy, "LASTUPDATE", "time.strftime(\"%m/%d/%Y\")",
										"PYTHON", "")
		...
		arcpy.CalculateField_management(CommunityParcelsLocalCopy, "IMPROVED", "improve", "VB",
										"Dim improve\\nIf [IMPVALUE] > 1 Then\\nimprove = \"YES\"\\n\\nelse\\nimprove = \"NO\"\\n\\nend if\\n")
	...
	arcpy.AddMessage(
		"Community Parcels upload started, please be patient.  For future consideration, please run tool during non-peak internet usage")
